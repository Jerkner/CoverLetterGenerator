...
I am writing to express my strong interest in the ${role} position at ${name}, as advertised on ${recruitingPage}. As a self-taught ${
                      role === "React Developer"
                          ? "React developer"
                          : role === "JavaScript Developer"
                          ? "JavaScript developer"
                          : role.toLowerCase()
                  } with a strong passion for design and UI/UX, I am eager to contribute my skills to your development team.
...
Jag skriver för att uttrycka mitt starka intresse för ${
                      role === "React Developer"
                          ? "React-utvecklare"
                          : role === "JavaScript Developer"
                          ...
                          ? "webbutvecklare"
                          : "frontend-utvecklare"
                  }-positionen på ${name}, som annonserades på ${recruitingPage}. Som en självlärd ${
                      role === "React Developer"
                          ? "React-utvecklare"
                          : role === "JavaScript Developer"
                          ? "JavaScript-utvecklare"
                          ...
                          ? "webbutvecklare"
                          : "frontend-utvecklare"
                  } med en passion för design och användarupplevelse ser jag fram emot att få bidra med mina färdigheter till ert utvecklingsteam.
...
Philip Jerkner`
    ...
    downloadButton.addEventListener("click", function () {
        ...
        pdfMake
            ...
            .download("Philip_Jerkner_Cover_Letter.pdf")
    })
})
